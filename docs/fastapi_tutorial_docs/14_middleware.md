...
[![a simple middleware demo](images/img54.png)](../img/img54.png)
...
decorator for the middleware function
...
[![initial logging](images/img55.png)](../img/img55.png)

After changing our logging using the middleware we created, the logging will look like this:

[![current logging](images/img56.png)](../img/img56.png)
