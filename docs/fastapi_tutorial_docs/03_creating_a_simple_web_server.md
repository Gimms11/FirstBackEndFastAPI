...
1. Create a new request collection
   [![Creatina request collection](images/img1.png)](../img/img1.png)
2. Name the request collection
   [![Name of the collection](images/img2.png)](../img/img2.png)
3. Create an HTTP request
   [![Create an HTTP request](images/img3.png)](../img/img3.png)
4. Make a request
   [![Make a request](images/img4.png)](../img/img4.png)
...
[![Greetings a User with a username](images/img14.png)](../img/img14.png)

Just in we make a request to the route without the param,
[![Greeting without a username specified](images/img142.png)](../img/img142.png)
...
[![Searching for a user who doesnot exist](images/img15.png)](../img/img15.png)

And searching for a user who does not exist returns the following response.
[![Searching a user who does not exist](images/img16.png)](../img/img16.png)
...
[![greeting a user with a username as a query param](images/img17.png)](../img/img17.png)

Note that this time if we do not provide the `username`, we shall get the default username of "User".
[![greeting with the default value of the username](images/img18.png)](../img/img18.png)
...
Using this `user_data`, we construct a new\_user dictionary and append it to our users list.
...
[![making request without request body](images/img19.png)](../img/img19.png)
...
[![request with missing fields in post data](images/img20.png)](../img/img20.png)
...
[![successful request with valid user data](images/img21.png)](../img/img21.png)
...
we have then created a request\_headers dictionary with the names of the headers as keys and the values as what we get by calling the `Header` function.
...
[![Response returning headers](images/img23.png)](../img/img23.png)
