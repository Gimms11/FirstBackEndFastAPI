...
[![Current database structure](images/img36.png)](../img/img36.png)
...
[![Modified database structure](images/img37.png)](../img/img37.png)
...
The user\_uid field in the Book class represents a foreign key relationship to the uid field in a hypothetical users table, linking each book entry to the user who submitted it. This field is optional (Optional[uuid.UUID]) and defaults to None, allowing for books that may not be associated with a specific user. When a user submits a book, their unique identifier (uid) would typically be stored in this field, enabling queries that link books to their respective owners. This design supports database integrity and enables efficient retrieval of books based on user ownership within the application's data model.
...
To ensure each book submission is associated with the currently authenticated user's user\_uid, we'll modify the BookService class in src/books/service.py. Here's how you can adjust the code to accommodate this:
...
getting the user\_uid from token details
...
[![creating a book](images/img38.png)](../img/img38.png)
...
[![Get user with books](images/img39.png)](../img/img39.png)
...
[![The user, books and reviews relationship](images/img40.png)](../img/img40.png)
...
At this point, you need to have disabled the lifespan event we created at in [chapter 5](../chapter5/). This is because we shall be using Alembic to make changes to our database,
...
1. **Adding a book review**:
   [![add a review to a book](images/img50.png)](../img/img50.png)
2. **Get book details with reviews**:
   [![get book reviews](images/img51.png)](../img/img51.png)
3. **Get user details with reviews**:
   [![get user reviews](images/img52.png)](../img/img52.png)
4. **Get all reviews**:
   [![get all book reviews](images/img53.png)](../img/img53.png)
...
[![tags database tables structure](images/img41.png)](../img/img41.png)

From the structure, it's evident that alongside our existing books table, we've introduced two additional tables: tags and book\_tags. We've established a many-to-many relationship between books and tags, facilitated by the book\_tags table. This table serves as an association table, linking instances from books to tags.
...
* `TagModel`: Represents a tag with a UUID (uid), name (name), and creation timestamp (created\_at). Used for reading and returning tag data from the API.
...
1. **Create tag**
   [![create tag](images/img43.png)](../img/img43.png)
2. **Create tag that exists**
   [![create tag that exists](images/img44.png)](../img/img44.png)
3. **Get all tags**
   [![get all tags](images/img45.png)](../img/img45.png)
4. **Add tags to a book**
   [![add tags to book](images/img46.png)](../img/img46.png)
5. **Update a tag**
   [![update a book](images/img47.png)](../img/img47.png)
6. **Delete a tag**
   [![delete a tag](images/img48.png)](../img/img48.png)
7. **Getting book details with tag**
   [![Get book with tags](images/img49.png)](../img/img49.png)
