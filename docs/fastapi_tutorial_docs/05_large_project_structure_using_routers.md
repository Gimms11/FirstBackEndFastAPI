...
Including the book router to our app
...
Furthermore, we added the following arguments to the include\_router method:
...
| /api/v1/books/{book\_id} | GET | Get a book by ID |
| /api/v1/books/{book\_id} | PATCH | Update a book by ID |
| /api/v1/books/{book\_id} | DELETE | Delete a book by ID |
