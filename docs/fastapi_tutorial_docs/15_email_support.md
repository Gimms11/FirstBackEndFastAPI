...
A function create\_message is defined to create an email message. It takes recipients, subject, and body as parameters and returns a MessageSchema object:
...
To send an email, we simply call the send\_message method on the mail object. Let's implement this in src/auth/routes.py:
`.
...
pydantic model for getting recipient email addresses
...
[![Successful email is sent](images/img57.png)](../img/img57.png)

To confirm if our email has been sent:

[![Confirming if the email is sent](images/img58.png)](../img/img58.png)
...
serializing and deserializing user's email address
...
[![send verification email](images/img59.png)](../img/img59.png)

We can confirm that the email has been sent

[![confirm if email has been sent](images/img60.png)](../img/img60.png)

Clicking the verification link will redirect the user back to the app, where the verification process is completed.

[![email verification URL not found](images/img61.png)](../img/img61.png)
...
update create\_url\_safe\_token
...
[![creating a user account with different credentials](images/img62.png)](../img/img62.png)

The verification will be sent successfully and the link will be sent as shown below.

[![verification email sent successfully](images/img63.png)](../img/img63.png)

[![Account Verifed Successfully](images/img64.png)](../img/img64.png)
...
account not verified custom exception
...
[![creating user account with vague email](images/img65.png)](../img/img65.png)
...
[![getting user credentials](images/img66.png)](../img/img66.png)

[![get all books](images/img67.png)](../img/img67.png)
