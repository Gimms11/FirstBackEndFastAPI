...
[![the OpenAPI specification](images/img80.png)](../img/img80.png)
...
[![swaggerUI](images/img81.png)](../img/img81.png)

We can use this UI to make requests to our API as shown below.

[![Swaggerui with request](images/img82.png)](../img/img82.png)
...
[![swagger UI with authorization](images/img83.png)](../img/img83.png)
...
[![Schema definitions](images/img84.png)](../img/img84.png)
...
[![details of the signup endpoint](images/img85.png)](../img/img85.png)
...
[![changed signhup endpoint](images/img86.png)](../img/img86.png)
...
[![Redoc](images/img87.png)](../img/img87.png)

We can get descriptions about the API endpoints, their methods, Request bodies and so on.

[![Book Create endpoint in Redoc](images/img88.png)](../img/img88.png)