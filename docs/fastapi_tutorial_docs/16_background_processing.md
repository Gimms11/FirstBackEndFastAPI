...
[![User registration response time](images/img68.png)](../img/img68.png)
...
[![creating a user account with background tasks](images/img69.png)](../img/img69.png)
...
[![Diagram illustrating Celery at work](images/img70.png)](../img/img70.png)
...
creating celery task for sending
...
Modifying code to use Celery tasks
...
sending email without Celery task
...
Sending the email with Celery background tasks
...
[![Celery Worker](images/img76.png)](../img/img76.png)
...
[![Worker Details](images/img77.png)](../img/img77.png)

You can also find information about the broker:

[![Broker Details](images/img78.png)](../img/img78.png)

Additionally, you can view details about tasks, their arguments, and their results:

[![Task Details](images/img79.png)](../img/img79.png)
