...
Most of the code here was explained in [Chapter 5](../chapter5/), so I will only cover what is new.
...
src/migrations/versions/8cf8276d5f3c\_init.py
...
Structure of the alembic\_version table
...
Structure of the user accounts table
