...
| /book/{book\_id} | GET | Get a book by id |
| /book/{book\_id} | PATCH | Update a book by id |
| /book/{book\_id} | DELETE | Delete a book by id |
...
5. **`/book/{book_id}` - GET: Get a book by id**
...
7. **`/book/{book_id}` - PATCH: Update a book by id**
...
9. **`/book/{book_id}` - DELETE: Delete a book by id**
...
[![List of Books](images/img5.png)](../img/img5.png)
...
[![get a book](images/img6.png)](../img/img6.png)
...
Pydantic model to define a book structure
...
[![Validation for no data being sent to the server](images/img7.png)](../img/img7.png)

Similarly, submitting incomplete or incorrect data results in validation errors:

[![Validation for incomplete or invalid data](images/img8.png)](../img/img8.png)
...
[![Successful creation of a new book record with valid JSON data](images/img9.png)](../img/img9.png)
...
[![successful updated of a book record](images/img10.png)](../img/img10.png)
...
[![retrieve updated book record](images/img11.png)](../img/img11.png)
...
[![delete a book record](images/img12.png)](../img/img12.png)
